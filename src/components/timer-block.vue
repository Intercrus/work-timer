  ...
  >
    <div class="timer__wrapper">
      <div class="timer__layout">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="36px" viewBox="0 0 24 24" width="36px" fill="#000000"><rect fill="none" height="24" width="24"/>
            <!-- Outlined reset icon -->
            <path
        ...
        <timer-btn
            ...
            class="timer__reset-timer-btn btn"
        >
        ...
        >
          ...
          <svg
              v-if="!isPaused"
              xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 0 24 24" width="36px" fill="#000000"
          >
